...
/* get 24 bit rgb from 16 bit compressed rgb */

long int uncompress_rgb(uint16_t non_compressed) {
	uint16_t r, g, b;
	
	r = ((non_compressed >> 11) << 5) & 0xFF;
	g = ((non_compressed >> 5) << 6) & 0xFF;
	b = (non_compressed << 5) & 0xFF;
